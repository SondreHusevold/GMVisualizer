...
public class FadeBackgroundPane extends JPanel {
    ...
    public FadeBackgroundPane(String imageFile) {
    	runningTime = 2000;
    	cl = this.getClass().getClassLoader();
    	this.setOpaque(false);
        try {
            inImage = ImageIO.read(new File("./Images/Backgrounds/" + imageFile));
            outImage = ImageIO.read(new File("./Images/Backgrounds/black.png"));
    ...
    public void changeImage(String fileName){
    	 try {
             inImage = ImageIO.read(new File("./Images/Backgrounds/" + fileName));
         } catch (IOException exp) {
         }
    	 fadeIn();
    }
